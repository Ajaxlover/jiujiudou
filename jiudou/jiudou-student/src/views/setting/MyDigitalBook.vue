          ...
          <div class="content-right-list">
            ...
            >
              ...
              <div class="item-right">
                ...
                <div class="item-right-intro">15268人已购买</div>
              </div>
            </div>
          </div>
        </div>
    ...
    getRecommendList() {
      axios
        .request({
          ...
          data: {
            pageNo: this.recommendPage.page,
        ...
        .then((res) => {
          let ret = res.data
          if (ret.code === 200) {
            this.recommendList = ret.data.records
            this.recommendPage.total = ret.data.total
          }
        })
    },
    getBookList() {
      axios
        ...
        .then((res) => {
          let ret = res.data
          if (ret.code === 200) {
            this.myBookList = ret.data.records
