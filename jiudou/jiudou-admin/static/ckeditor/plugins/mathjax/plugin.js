...
( function() {
	...
	CKEDITOR.plugins.mathjax.trim = function( value ) {
		var begin = value.indexOf( '$' )+1, end = value.lastIndexOf( '$' );
							...
							'<head>' +
								...
								'<script type="text/x-mathjax-config">' +
									...
									'MathJax.Hub.Config( {' +
							            ...
							            'tex2jax: { inlineMath: [["$","$"]],displayMath: [["$$","$$"]] ,skipTags: ["script", "img", "noscript", "style", "textarea", "pre","code","a"],ignoreClass:"class1",processEscapes: true},' +
							            '"HTML-CSS": { scale: 85, imageFont: null}' +
									'} );' +
