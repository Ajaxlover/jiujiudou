      ...
      axios
        ...
        .then(res => {
          ...
          if (ret.code === 200) {
            ...
            // this.form.beginUid = appointUid;
            // this.form.beginPhone = appointMobile;
            this.form.contestSureContent = content;
            this.form.coverPFile = coverUrl;
            this.form.contestAnswerContent = credible;
            this.form.introUrl = introduction;
            this.form.isNotFree = isFee == 1;
            this.form.name = name;
            this.form.contestReadingContent = notes;
            this.form.price = price;
            let competeListTemp = [];
            competeList.forEach((i, idx) => {
              competeListTemp.push({
                competeName: i.name,
                phone: i.appointMobile,
                uid: i.appointUid,
            ...
            this.form.competeList = competeListTemp;
          } else {
            this.$message({
              type: "error",
              message: "服务器错误"
