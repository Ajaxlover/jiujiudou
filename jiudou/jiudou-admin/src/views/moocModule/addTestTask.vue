...
export default {
  ...
  data() {
    return {
      ...
      allRateLevel: common.allRateLevel,
      tipTreeStyle: {
        width: "130px"
      },
      selectParams: {
        ...
        if (this.contentList.length > 0) {
          ...
          if (this.currentTestTaskId) {
            ...
            axios
              .request({
                method: "post",
                url: "/openccourse/ccourseCatalog/editTask",
                data: {
                  id: this.currentTestTaskId,
            ...
            axios
              .request({
                method: "post",
                url: "/openccourse/ccourseCatalog/addTask",
                data: {
                  courseId: this.catalogCourseId,
                  parentId: this.catalogParentId,
                  content: JSON.stringify(dataList),
        ...
        .then(res => {
          ...
          if (ret.code === 200) {
            ...
            if (arr && arr.length > 0) {
              ...
              console.log(this.cloudForm.cloudTest);
            } else {
