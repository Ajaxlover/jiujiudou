<template>
  <el-container class="myRes-textBook">
    <!-- 教材资源库列表 -->
      ...
      axios
        ...
        .then(
          function(data) {
            ...
            let res = data.data;
            if (res.code == 200) {
              if (res.data.bookUpdate && res.data.bookUpdate.length > 0) {
                this.resListData = res.data.bookUpdate;
                this.chapterList = this.resListData[0].catalogInfo;
