          ...
          <el-table-column label="时间" align="center">
            <template slot-scope="scope">
              ...
              <div v-if="scope.row.publishTime">
                发布时间:{{ timeFormat(scope.row.publishTime) }}
              </div>
            </template>
          </el-table-column>
        ...
        >
          ...
          <el-form-item label="编辑方式" prop="title">
            ...
            >
              ...
              <el-option label="Epub编辑方式" value="1"></el-option>
            </el-select>
          </el-form-item>
...
export default {
  ...
  methods: {
    ...
    clearAddForm() {
      ...
      this.addForm.price = "";
      this.addForm.bookIntro = "";
      this.addForm.authorIntro = "";
    },
    copyDtBook(row) {
    ...
    doTransfer() {
      if (this.selectedMember > 0) {
        axios
          .request({
            method: "post",
            url: "/ebook/digitalBook/transference",
            data: {
              dtbookId: this.currentDtBook.dtbookId,
              targetUid: this.selectedMember
            }
          })
          .then(res => {
            let ret = res.data;
