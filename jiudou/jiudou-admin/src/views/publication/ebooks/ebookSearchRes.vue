          ...
          >
            ...
            <el-table-column label="资源展示名" align="center">
              <template slot-scope="scope">
                <el-input
                  size="small"
                  v-model="scope.row.matchPicName"
                  maxlength="50"
                  show-word-limit
                ></el-input>
              </template>
            ...
            <!-- <el-table-column label="图序" align="center" width="150px">
              <template slot-scope="scope">
                <el-input size="small" v-model="scope.row.resPicNum" maxlength="8" show-word-limit></el-input>
              </template>
            </el-table-column> -->
  ...
  methods: {
    ...
    doBindBookRes() {
      ...
      this.stepTableData.forEach(element => {
        if (element.matchPicName == "" || element.matchPicName.length > 16) {
          flag = false;
        }
        if (element.resPage == "") {
          flag = false;
      ...
      if (flag) {
        axios
          .request({
            method: "post",
            url: "/ebook/ebMatchPic/ebookBingResource",
            data: {
              bookId: this.id,
