<template>
  <el-container class="bookInfo">
    <el-header height="50px">
      <span class="book" @click="toBook">电子书管理</span> <i class="el-icon-arrow-right"></i> <span>编辑电子书</span>
    </el-header>
    <el-main>
      <el-tabs v-model="activeName" class="main-tabs">
        <el-tab-pane label="电子书信息" name="first">
          <basic-info :id="id" v-on:addSuccess="addSuccess" v-on:saveSuccess="saveSuccess"></basic-info>
        </el-tab-pane>
        <el-tab-pane label="电子书资源" name="second" v-if="id">
...
import BookResource from './ebookResource'
