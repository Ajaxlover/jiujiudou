  ...
  <el-container class="bookInfo">
    ...
    <el-main>
      <div class="chapter-info-top">
        ...
        <div class="dtbook-pub-btns">
          ...
          <el-button type="text" @click="toSend">
            <template>
              <div
                style="width:100px;height:60px;display:flex;flex-direction:column;justify-content:center"
              >
                <i
                  ...
                  style="font-size:25px;margin-bottom:5px"
                ></i>
                <span style="color:#666">稿件投递</span>
              </div>
            </template>
          </el-button>
      ...
      <div class="chapter-info-b">
        <el-tabs v-model="activeName" @tab-click="handleTabClick">
          ...
          <el-tab-pane label="全书概览" name="third">
            <div>数据概览</div>
          </el-tab-pane>
          ...
          <el-tab-pane label="投递记录" name="fifth">
            <div>
              <div
                  ...
                  >
                    ...
                    >
                      <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.status == 2">退回稿件</span>
    ...
    >
      ...
      <div slot="footer" class="dialog-footer">
        <el-button
          :disabled="!userResultChangeChapter.uid"
          type="primary"
          size="small"
          @click="doAddMemberChangeChapter"
          >确定</el-button
        >
    ...
    >
      ...
      <span slot="footer">
        <el-button size="small" type="primary" @click="doSend">投递</el-button>
    ...
    >
      ...
      <div>
        <div style="margin-bottom:20px">
          <el-checkbox style="font-size:16px" v-model="publishSelectAll"
            >全部章节</el-checkbox
          >
        ...
        <div>
          <span>基本信息设置确认</span>
          <el-button type="text" size="small">去确认</el-button>
        </div>
      </div>

      <span slot="footer">
        <el-button size="small" type="primary">申请发布</el-button>
...
export default {
  ...
  methods: {
    ...
    doMoveNode() {
      ...
      let data = {};
      data.nodeVersionId = this.currentMoveNode.nodeVerSionId;
      data.title = this.moveNodeForm.name;
      data.targetChapterVersionId = this.moveNodeForm.chapter;
    ...
    toSend() {
      ...
      this.sendForm.name = this.bookBaseInfo.tname;
      this.sendForm.author = this.bookBaseInfo.author;
      this.sendForm.subjectType = this.bookBaseInfo.sid;
      this.sendForm.editType = String(this.bookBaseInfo.editType);
    },
    // 投递
    doSend() {
      if (!this.sendForm.name) {
        this.$message({
          type: "warning",
          message: "请填写书名"
        });
      ...
      let data = {};
      data.dtbookId = this.dtbookId;
      data.tname = this.sendForm.name;
      data.author = this.sendForm.author;
      data.sid = this.sendForm.subjectType;
      data.pubId = this.sendForm.pubId;
      // data.coverPic
      data.description = this.sendForm.sendRemark;
      axios
        .request({
          method: "post",
          url: "/ebook/digitalBook/progress/authorContribute",
          data
        })
        .then(res => {
          let ret = res.data;
    ...
    doSure() {
      ...
      axios
        .request({
          method: "post",
          url: "/ebook/digitalBook/updateBaseInfoByTeacher",
          data
        })
        .then(res => {
          let ret = res.data;
    ...
    getPubList() {
      ...
      axios
        .request({
          method: "post",
          url: "/ebook/digitalBook/progress/queryTeacherBookProgressPage",
          data: params
        })
        .then(res => {
          let ret = res.data;
    ...
    queryResTypeCount() {
      ...
      axios
        .request({
          method: "post",
          url: "/ebook/digitalBook/Subordinate/queryResTypeCount",
          data
        })
        .then(res => {
          let ret = res.data;
