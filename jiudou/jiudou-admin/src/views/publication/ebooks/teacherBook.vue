    ...
    <el-main>
      <div class="top">
        ...
        >
          ...
          <el-option label="编辑中" value="3"></el-option>
          <el-option label="已退稿" value="4"></el-option>
        </el-select>
      ...
      <div class="main">
        ...
        >
          ...
          <el-table-column label="投稿人" align="center">
          ...
          <el-table-column label="状态" align="center">
            <div slot-scope="scope">
              ...
              <span v-if="scope.row.status == 3">编辑中</span>
              <span v-if="scope.row.status == 4">已退稿</span>
            </div>
          </el-table-column>
          <el-table-column label="操作" align="center" width="200">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                type="text"
                size="small"
                @click="toReBack(scope.row)"
                >退稿</el-button
              >
              <el-button type="text" size="small" @click="toReMark(scope.row)"
                >备注</el-button
              >
              <!-- <el-button
                type="text"
                size="small"
                @click="toReBackList(scope.row)"
                >投稿记录</el-button
              > -->
              <!-- <el-button
                type="text"
    ...
    >
      ...
      <div>
        <div style="margin-bottom:15px;font-size:16px">
          版本号：{{ currentToEditorBook.versionCode }}
        </div>
        <div style="margin-bottom:15px;font-size:16px">
          投稿时间：{{ timeFormat(currentToEditorBook.submitTime) }}
        </div>
        <!-- <div style="margin-bottom:15px;font-size:16px">转入编辑时间：333</div> -->
        <div style="margin-bottom:15px;font-size:16px">
          投稿备注：{{
            currentToEditorBook.description
              ? currentToEditorBook.description
              : "无"
          }}
        </div>
...
export default {
  ...
  methods: {
    ...
    toEditor() {
      ...
      data.editorUid = this.$store.state.user.userId;
      data.coverPic =
        "https://test.guangyiedu.com/exam/masterHead/202402/bfa93528a12f402aa91daccc2ef9f6aa.png";
    ...
    loadData() {
      ...
      params.editorUid = this.$store.state.user.userId;
      if (this.searchForm.keyWord) {
        params.keyWord = this.searchForm.keyWord;
      }
      if (this.searchForm.pubPlan) {
        params.handleStatus = this.searchForm.pubPlan;
      }
      ...
      axios
        .request({
          ...
          url: "/ebook/digitalBook/progress/queryAssignMysContributionPage",
          data: params
        })
        .then(res => {
          this.loading = false;
    ...
    transEdit(row) {
      ...
      this.addForm.subjectType = row.sid;
      this.addForm.editType = String(row.editType);
    },
    toReBack(row) {
      this.currentDtBook = row;
