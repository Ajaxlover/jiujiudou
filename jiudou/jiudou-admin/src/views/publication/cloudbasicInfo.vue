  ...
  <div class="basicInfo">
    <el-collapse v-model="activeName" accordion>
      <el-collapse-item title="基本信息" name="first">
        <el-form :model="basicForm" :rules="basicRules" ref="basicForm" label-width="120px" disabled>
          <el-form-item label="封面">
            <img v-if="basicForm.imageUrl" :src="basicForm.imageUrl" alt="" class="userPic" style="width:98px;height:135px;">
            <img v-else src="@/assets/images/img_add.png" alt="" class="userPic" style="width:98px;height:135px;">
          </el-form-item>
      ...
      <el-collapse-item title="其他出版信息(选填)" name="third">
        <el-form :model="pubForm" ref="pubForm" label-width="120px" disabled>
      ...
      this.$refs['basicForm'].validate((valid) => {
        if (valid) {
          ...
          if(this.bookId) {
            ...
            url = '/v1/textbook/updateIssueTextbookOrg'
          }
          if(this.file) {
