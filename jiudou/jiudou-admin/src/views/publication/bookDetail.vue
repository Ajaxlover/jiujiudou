<template>
  <div class="bookDetail">
    <el-header height="50px">
      ...
      <i class="el-icon-arrow-right"></i> <span>教材详情</span>
    </el-header>
      ...
      <el-tabs class="info" v-model="currentIdx">
        ...
        <el-tab-pane label="教材资源" name="second">
          ...
          <el-tabs class="resTabs" v-model="resCurrent">
            ...
            <el-tab-pane label="教师资源包" name="forth">
              <div
                style="width:700px;margin:130px 0"
                v-loading="loading.teaResLoading"
              >
                <div v-if="teaResZipList.length > 0" style="text-align:center">
                  <img
                    style="width:90px;"
                  ...
                  >
                    ...
                    <span>
                      <span style="font-size:13px;">{{
                        formatBookResSize(item.resSize)
                      }}</span>
            ...
            <!-- <el-tab-pane label="教师资源包" name="sixth">
              <div
                style="width:700px;margin:130px 0"
                v-loading="loading.teaResZipLoading"
              >
                <div v-if="teaResZipList.length > 0" style="text-align:center">
                  <img
                    style="width:90px;"
...
export default {
  ...
  methods: {
    //加载教师资源包
    loadTeaResZip() {
      this.loading.teaResZipLoading = true;
      axios
        .request({
          method: "post",
        ...
        .then(res => {
          let ret = res.data;
          this.loading.teaResZipLoading = false;
          if (ret.code === 200) {
