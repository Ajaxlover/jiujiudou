  ...
  <el-container class="repeat-score">
    <el-header style="height: 50px">
      <span @click="toExamCheck" style="cursor:pointer;color:#2BA1F4;"
        >返回</span
      >
      <i class="el-icon-arrow-right"></i> <span>复批结果</span>
    </el-header>
    <el-container>
...
"
      ...
      <span slot="footer" class="dialog-footer">
        <el-button size="small" @click="checkSure" type="primary"
          >确定</el-button
        >
...
import timu from "./examResultTimu.vue";
...
export default {
  ...
  data() {
    return {
      ...
      reviewUid: this.$route.query.reviewUid,
  ...
  methods: {
      ...
      this.$refs["scoreForm"].validate(valid => {
        if (valid) {
          ...
          if (!this.notPic) {
                  ...
                  axios
                    ...
                    .then(res => {
                      ...
                      if (res.status == 200) {
                        ...
                        picData.append("resultReadId", this.resultReadId);
            ...
            data.append("resultReadId", this.resultReadId);
            if (this.pTimu.parentId > 0) {
              data.append("reviewResultReadId", this.pTimu.resultReadId);
            } else {
              data.append("reviewResultReadId", this.resultReadId);
            }
    ...
    getTimuDetail() {
      axios
        .request({
          method: "post",
          url: "/exam/exam/result/readOver/findReviewInfo",
          data: {
