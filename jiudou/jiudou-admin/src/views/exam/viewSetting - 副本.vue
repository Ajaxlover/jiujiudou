              ...
              <el-form-item label="答卷次数">
                ...
                >
                  ...
                  <el-tooltip effect="dark" placement="right">
                    <div slot="content">
                      1.学生可有多次作答机会，超过设定次数后，学生无法再参与作答；<br />2.学生如多次作答提交，系统将以学生得分最高次的卷面为准；<br />3.答卷次数>1次时，考试迟到设置将对学生第二次作答失效
                    </div>
                    <img
                      style="width:15px;"
            ...
            <div class="bottom-f">
              <el-form>
                <el-form-item label="考试迟到限时">
                  <el-switch disabled v-model="form.isLateMinute"></el-switch>
                  <span
                    >学生可迟到<el-input
                      disabled
                      style="width:60px"
                  ...
                  <el-tooltip effect="dark" placement="right">
                    <div slot="content">
                      1.开启：待考试开始，学生必须在设定时间范围内进入答题，否则将无法参与考试；<br />2.如答卷次数>1，迟到设置仅对学生第一次作答有效
                    </div>
                    <img
            ...
            <div class="bottom-f">
              <el-form ref="form" :model="form">
                ...
                <el-form-item label="选项是否随机">
                  <el-switch disabled v-model="form.isOptionRandom"></el-switch>
                  <el-tooltip effect="dark" placement="right">
                    <div slot="content">
                ...
                <el-form-item label="试卷随机抽取">
                  <el-switch disabled v-model="form.extractRandom"></el-switch>
                </el-form-item>
                <el-form-item label="">
                    ...
                    <el-form ref="form" :model="form">
                      ...
                      <el-form-item label="">
                        <el-radio-group size="small" v-model="form.showAnswer">
                          <el-radio disabled label="2">显示答案解析</el-radio>
                          <el-radio disabled label="3">不显示答案解析</el-radio>
                          <el-tooltip effect="dark" placement="right">
                            <div slot="content">
                              学生查看卷面时，是否显示标准答案
                            </div>
