<template>
  <el-container class="addTimu">
    <el-header height="50px">
      <span class="" @click="toPaper">创建考试</span>
      <i class="el-icon-arrow-right"></i> <span>考试添加试题</span>
    </el-header>
    <el-main>
...
export default {
  ...
  data() {
    return {
      ...
      examId: this.$route.query.examId, // 是自测习题还是教材习题
      loading: {
        resLoading: false
      },
      comTKList: [], // 公共库列表
  ...
  methods: {
    ...
    doAddTimuSure() {
      ...
      axios
        .request({
          method: "post",
          url: "/exam/exam/paper/addSubject",
          data: {
