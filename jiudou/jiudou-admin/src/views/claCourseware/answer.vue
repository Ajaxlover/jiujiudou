  ...
  <div class="answer">
    ...
    >
      <addAnswerTest
        v-if="drawer"
        :addType="1"
        :answerDuration="Number(selectTime)"
        v-on:toCloseDrawer="toCloseDrawer"
        @answerSuccess="answerSuccess"
      ></addAnswerTest>
    </el-drawer>
    <div class="answerList">
      <div v-if="isShowStartAnswer" class="answerListHeader" style="color:#333">
        <span
      ...
      <div v-else class="answerListHeader">
        <span class="backBtn" type="text" @click="back"
          ><i class="el-icon-back"></i>返回</span
        >
      </div>
    </div>
    <div v-if="isShowStartAnswer" class="answerContent">
      <div class="sendText">发起应答</div>
      <div class="setTime">
        <div
          style="width:407px;height:78px;border:1px solid #1c272e;border-radius:4px;padding-top:20px;margin:0 auto"
        >
          <span style="color:#1c272e;font-size:24px;">应答时长</span>
          <el-select
            v-model="selectTime"
            size="small"
