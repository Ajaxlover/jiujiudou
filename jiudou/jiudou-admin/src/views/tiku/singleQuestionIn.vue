            ...
            <!-- <div
              v-if="
                subjectForm.tSubject != 1 &&
                  subjectForm.tSubject != 2 &&
                  subjectForm.tSubject != 3 &&
                  subjectForm.tSubject != 4 &&
                  subjectForm.tSubject != 11
              "
            >
              <textarea
                name="answer"
...
import editChildren from "./editChidren";
  ...
  methods: {
    childValue(jsonStr) {
      ...
      if (this.row) {
        ...
        // 大题新增时新增小题  小题status设置为启用
        let newJsonStr = Object.assign(jsonStr, { status: 2 });
        this.addSonList.push(newJsonStr);
      }
