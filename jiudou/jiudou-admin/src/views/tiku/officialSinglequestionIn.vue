...
import officialAddChildren from "./officialAddChildren";
import officialEditChildren from "./officialEditChildren";
import preview from "./previewSubject";
import ElTreeSelect from "@/components/el-tree-select/src/ElTreeSelect";

export default {
  name: "officialCommonQuestionIn",
  components: {
    officialAddChildren,
    officialEditChildren,
    "jd-dialog": jdialog,
