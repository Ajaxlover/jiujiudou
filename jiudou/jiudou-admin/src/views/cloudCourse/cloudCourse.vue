          ...
          >
            <div slot-scope="scope" class="info">
              ...
              <div class="middle">
                ...
                <div class="cloudId">云课ID: {{ scope.row.ccourseUuid }}</div>
                <div class="price">{{ formatPrice(scope.row) }}</div>
              </div>
              <div class="courseTime">
                {{ dateFormat(scope.row.ccourseModifyTime) }}
              </div>
              <div class="right">
                <span
                  :style="
                    scope.row.ccourseStatus == 3 ? 'color:red' : 'color:#2BA1F4'
                  "
          ...
          <el-table-column label="操作" align="center" width="150">
            <template slot-scope="scope">
              ...
              <el-button
                ...
                v-if="
                  scope.row.ccourseStatus == 0 || scope.row.ccourseStatus == 3
                "
                style="margin-left:0"
                >编辑</el-button
              >
              <el-button
                ...
                v-if="
                  (scope.row.ccourseStatus == 0 ||
                    scope.row.ccourseStatus == 3) &&
                    scope.row.ccourseIsMain == 1
                "
                style="margin-left:0"
                >删除</el-button
              >
