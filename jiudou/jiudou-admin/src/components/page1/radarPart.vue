    ...
    >
      ...
      <template v-if="isIE">
        ...
        >
          ...
          <polyline
            points="110,389 124.5,389 112.5,398 117.5,384 122,398 110,389"
            fill-opacity="0.8"
            :fill="psychologicalRate >= 1 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="128,389 141.5,389 130.5,398 134.8,384 139,398 128,389"
            fill-opacity="0.8"
            :fill="psychologicalRate >= 2 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="144,389 157.5,389 146.5,398 150.8,384 155,398 144,389"
            fill-opacity="0.8"
            :fill="psychologicalRate >= 3 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="160,389 173.5,389 162.5,398 166.8,384 171,398 160,389"
            fill-opacity="0.8"
            :fill="psychologicalRate >= 4 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="177,389 190.5,389 179.5,398 183.8,384 189,398 177,389"
            fill-opacity="0.8"
            :fill="psychologicalRate >= 5 ? '#FED723' : '#fff'"
          ></polyline>
        </g>
        ...
        >
          <image
            ...
            y="224"
            :xlink:href="
              speechStatus ? $images.sensitive_title : $images.normal_title
            "
            width="130"
            height="50"
          />
          ...
          <polyline
            points="85,260 98.5,260 87.5,269 91.5,255 96,269 85,260"
            fill-opacity="0.8"
            :fill="speechRate >= 1 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="103,260 116.5,260 105.5,269 109.5,255 114,269 103,260"
            fill-opacity="0.8"
            :fill="speechRate >= 2 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="119,260 132.5,260 121.5,269 125.5,255 130,269 119,260"
            fill-opacity="0.8"
            :fill="speechRate >= 3 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="135,260 148.5,260 137.5,269 141.5,255 146,269 135,260"
            fill-opacity="0.8"
            :fill="speechRate >= 4 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="152,260 165.5,260 154.5,269 158.5,255 163,269 152,260"
            fill-opacity="0.8"
            :fill="speechRate >= 5 ? '#FED723' : '#fff'"
          ></polyline>
        </g>
        <g class="text" ref="text_2">
          ...
          <template v-else>
            ...
            <text x="270" y="405" fill="#AFE5FB" v-if="showBisexual">
              需关注两性健康
            </text>
            <text
              x="270"
              :y="showBisexual ? 435 : 405"
              fill="#AFE5FB"
              v-if="showViolate"
            >
              需关注违禁行为
        ...
        >
          ...
          <polyline
            points="110,145 123.5,145 112.5,154 116.5,140 121,154 110,145"
            fill-opacity="0.8"
            :fill="internetPreferenceRate >= 1 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="128,145 141.5,145 130.5,154 134.5,140 139,154 128,145"
            fill-opacity="0.8"
            :fill="internetPreferenceRate >= 2 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="144,145 157.5,145 146.5,154 150.5,140 155,154 144,145"
            fill-opacity="0.8"
            :fill="internetPreferenceRate >= 3 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="160,145 173.5,145 162.5,154 166.5,140 171,154 160,145"
            fill-opacity="0.8"
            :fill="internetPreferenceRate >= 4 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="177,145 190.5,145 179.5,154 183.5,140 188,154 177,145"
            fill-opacity="0.8"
            :fill="internetPreferenceRate >= 5 ? '#FED723' : '#fff'"
          ></polyline>
        </g>
        <g class="text" ref="text_3">
          ...
          <text
            v-for="(item, index) in internetPreferenceUrl"
            :key="item"
            x="270"
            fill="#AFE5FB"
            :y="405 + index * 30"
        ...
        >
          <image
            ...
            y="40"
            :xlink:href="
              riskStatus ? $images.sensitive_title : $images.normal_title
            "
            width="130"
            height="50"
          />
          ...
          <polyline
            points="333,75 346.5,75 335.5,84 339.5,70 344,84 333,75"
            fill-opacity="0.8"
            :fill="riskRate >= 1 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="351,75 364.5,75 353.5,84 357.5,70 362,84 351,75"
            fill-opacity="0.8"
            :fill="riskRate >= 2 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="367,75 380.5,75 369.5,84 373.5,70 378,84 367,75"
            fill-opacity="0.8"
            :fill="riskRate >= 3 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="383,75 396.5,75 385.5,84 389.5,70 394,84 383,75"
            fill-opacity="0.8"
            :fill="riskRate >= 4 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="400,75 413.5,75 402.5,84 406.5,70 411,84 400,75"
            fill-opacity="0.8"
            :fill="riskRate >= 5 ? '#FED723' : '#fff'"
          ></polyline>
        </g>
        <g class="text" ref="text_4">
          ...
          <template v-else>
            ...
            <text x="270" y="405" fill="#AFE5FB" v-if="existViolations">
              警惕设备违规风险
            </text>
            <text
              x="270"
              :y="existViolations ? 435 : 405"
              fill="#AFE5FB"
              v-if="existOutOfControl"
            >
              警惕设备脱离管控风险
            </text>
            <text
              x="270"
              :y="
                existViolations && existOutOfControl
                  ? 465
                  : existViolations || existOutOfControl
                  ? 435
                  : 405
        ...
        >
          ...
          <polyline
            points="562,145 570.5,145 559.5,154 563.5,140 568,154 557,145"
            fill-opacity="0.8"
            :fill="entertainmentPreferenceRate >= 1 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="573,145 585.5,145 575.5,154 579.5,140 584,154 573,145"
            fill-opacity="0.8"
            :fill="entertainmentPreferenceRate >= 2 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="589,145 602.5,145 591.5,154 595.5,140 600,154 589,145"
            fill-opacity="0.8"
            :fill="entertainmentPreferenceRate >= 3 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="605,145 618.5,145 607.5,154 611.5,140 616,154 605,145"
            fill-opacity="0.8"
            :fill="entertainmentPreferenceRate >= 4 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="622,145 635.5,145 624.5,154 628.5,140 633,154 622,145"
            fill-opacity="0.8"
            :fill="entertainmentPreferenceRate >= 5 ? '#FED723' : '#fff'"
          ></polyline>
        </g>
        ...
        >
          <image
            ...
            y="224"
            :xlink:href="
              makeFriendStatus ? $images.sensitive_title : $images.normal_title
            "
            width="130"
            height="50"
          />
          ...
          <polyline
            points="588,260 601.5,260 590.5,269 594.5,255 599,269 588,260"
            fill-opacity="0.8"
            :fill="makeFriendRate >= 1 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="606,260 619.5,260 608.5,269 612.5,255 617,269 606,260"
            fill-opacity="0.8"
            :fill="makeFriendRate >= 2 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="622,260 635.5,260 624.5,269 628.5,255 633,269 622,260"
            fill-opacity="0.8"
            :fill="makeFriendRate >= 3 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="638,260 651.5,260 640.5,269 644.5,255 649,269 638,260"
            fill-opacity="0.8"
            :fill="makeFriendRate >= 4 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="655,260 668.5,260 657.5,269 661.5,255 666,269 655,260"
            fill-opacity="0.8"
            :fill="makeFriendRate >= 5 ? '#FED723' : '#fff'"
          ></polyline>
        </g>
        ...
        >
          <image
            ...
            y="354"
            :xlink:href="
              consumptionCharacteristicsStatus
                ? $images.sensitive_title
                : $images.normal_title
            "
            width="130"
          ...
          <polyline
            points="565,390 578.5,390 567.5,399 571.5,385 576,399 565,390"
            fill-opacity="0.8"
            :fill="consumptionCharacteristicsRate >= 1 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="583,390 596.5,390 585.5,399 589.5,385 594,399 583,390"
            fill-opacity="0.8"
            :fill="consumptionCharacteristicsRate >= 2 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="599,390 612.5,390 601.5,399 605.5,385 610,399 599,390"
            fill-opacity="0.8"
            :fill="consumptionCharacteristicsRate >= 3 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="615,390 628.5,390 617.5,399 621.5,385 626,399 615,390"
            fill-opacity="0.8"
            :fill="consumptionCharacteristicsRate >= 4 ? '#FED723' : '#fff'"
          ></polyline>
          <polyline
            points="632,390 645.5,390 634.5,399 638.5,385 643,399 632,390"
            fill-opacity="0.8"
            :fill="consumptionCharacteristicsRate >= 5 ? '#FED723' : '#fff'"
          ></polyline>
        </g>
          ...
          >
            <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
              <div class="promptBox">
                ...
                <div class="psychologyContent" v-else>
                  <div>
                    <span>{{ speech }}人</span>(<span>{{ speechPercent }}</span
                    >)言论特征需关注
                  </div>
            ...
            <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
              <p :style="{ color: internetPreferenceStatus ? '#FFDBDB' : '' }">
                ...
                <Rate
                  :show-text="false"
                  disabled
                  v-model="internetPreferenceRate"
                >
                </Rate>
              </p>
            </div>
              ...
              <div class="promptBox">
                ...
                <div class="psychologyContent">
                  <div>
                    ...
                    >){{
                      showInternetPreference
                        ? "上网访问存在风险"
                        : "上网访问无风险"
                    }}
                  </div>
                  <div v-for="item in internetPreferenceUrl" :key="item">
                    {{ item }}
                  </div>
                </div>
              </div>
          ...
          >
            <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
              <p :style="{ color: riskStatus ? '#FFDBDB' : '' }">
                ...
                <Rate :show-text="false" disabled v-model="riskRate"> </Rate>
              </p>
            </div>
          </foreignObject>
          <foreignObject
          ...
          >
            <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
              <div class="promptBox">
                ...
                <div class="psychologyContent" v-else>
                  <div>
                    <span>{{ risk }}人</span>(<span>{{ riskPercent }}</span
                    >)触发风险意识
                  </div>
        ...
        <g>
          ...
          >
            <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
              <p
                :style="{
                  color: entertainmentPreferenceStatus ? '#FFDBDB' : ''
                }"
              >
                ...
                <Rate
                  :show-text="false"
                  disabled
                  v-model="entertainmentPreferenceRate"
                  class="entertainment"
                >
                </Rate>
              </p>
          ...
          >
            <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
              <div class="promptBox">
                ...
                <p
                  v-if="!showEntertainmentPreference"
                  style="text-align: center;margin-top: 40px;"
                >
                  {{ entertainmentPreference }}
                </p>
                <div class="psychologyContent" v-else>
                  <div>
                    <span>{{ entertainmentPreference }}人</span>(<span>{{
        ...
        <g>
          ...
          >
            <div class="title-text-box" xmlns="http://www.w3.org/1999/xhtml">
              <p
                :style="{
                  color: consumptionCharacteristicsStatus ? '#FFDBDB' : ''
                }"
              >
                ...
                <Rate
                  :show-text="false"
                  disabled
                  v-model="consumptionCharacteristicsRate"
                >
                </Rate>
              </p>
            </div>
          ...
          >
            <div class="text-box" xmlns="http://www.w3.org/1999/xhtml">
              <div class="promptBox">
                ...
                <p
                  v-if="!showConsumptionCharacteristics"
                  style="text-align: center;margin-top: 40px;"
                >
                  {{ consumptionCharacteristics }}
                </p>
                <div class="psychologyContent" v-else>
                  <div>
                    <span>{{ consumptionCharacteristics }}人</span>(<span>{{
...
export default {
  ...
  methods: {
    ...
    onmouseenter(e) {
      ...
      document
        .querySelectorAll(".swap1")
        .forEach(item => (item.style.strokeDashoffset = 130));
      document
        .querySelectorAll(".swap2")
        .forEach(item => (item.style.strokeDashoffset = 190));
      document
        .querySelectorAll(".swap3")
        .forEach(item => (item.style.strokeDashoffset = 240));
      document
        .querySelectorAll(".swap4")
        .forEach(item => (item.style.strokeDashoffset = 295));
